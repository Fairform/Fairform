...
export default function Features() {
  return (
    <section className="py-20 relative overflow-hidden">
      ...
      >
        <div className="p-6 bg-[#171719]/50 backdrop-blur-sm rounded-xl border border-[#252529]">
          ...
          <p className="text-[#a0a0a6]">Policy generation</p>
        </div>
        ...
        <div className="p-6 bg-[#171719]/50 backdrop-blur-sm rounded-xl border border-[#252529]">
          ...
          <p className="text-[#a0a0a6]">Regulation accuracy</p>
        </div>
        ...
        <div className="p-6 bg-[#171719]/50 backdrop-blur-sm rounded-xl border border-[#252529]">
          ...
          <p className="text-[#a0a0a6]">Audit failures</p>
        </div>
        ...
        <div className="p-6 bg-[#171719]/50 backdrop-blur-sm rounded-xl border border-[#252529]">
          ...
          <p className="text-[#a0a0a6]">Businesses</p>
        </div>
      </motion.div>
    </section>
  );
